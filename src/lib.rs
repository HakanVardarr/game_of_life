...
pub fn game_init(game: &mut GameOfLife) {
    ...
    game.board.cells[15][15] = Cell::live();
    game.board.cells[16][15] = Cell::live();
    game.board.cells[16][13] = Cell::live();
    game.board.cells[17][15] = Cell::live();
    game.board.cells[17][14] = Cell::live();

    game.board.cells[18][24] = Cell::live();
    game.board.cells[19][23] = Cell::live();
    game.board.cells[19][22] = Cell::live();
    game.board.cells[20][23] = Cell::live();
    game.board.cells[20][24] = Cell::live();
